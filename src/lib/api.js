...
const mockProdutos = [
  { id: 1, nome: 'X-Burguer', categoria: 'Lanches', preco: 18, disponivel: 1, estoque_atual: 50, estoque_minimo: 10, imagem: 'https://images.unsplash.com/photo-1568901346375-23c9450c58cd?w=400&q=80', descricao: 'Hambúrguer artesanal, queijo, alface, tomate e molho especial', custo_unitario: 7.5, unidade: 'un', permite_meio_meio: 0, sort_order: 1, adicionais: [{ nome: 'Bacon', preco: 4 }, { nome: 'Cheddar extra', preco: 3.5 }, { nome: 'Ovo', preco: 2 }, { nome: 'Sem picles', preco: 0 }] },
  ...
  { id: 14, nome: 'Açaí 300ml', categoria: 'Sobremesas', preco: 16, disponivel: 1, estoque_atual: 40, estoque_minimo: 8, imagem: 'https://images.unsplash.com/photo-1590080875515-8a3a8dc5735e?w=400&q=80', descricao: 'Açaí batido com guaraná, banana e granola', custo_unitario: 6, unidade: 'un', permite_meio_meio: 0, sort_order: 14, adicionais: [{ nome: 'Leite condensado', preco: 2 }, { nome: 'Granola', preco: 1.5 }, { nome: 'Morango', preco: 3 }] },
